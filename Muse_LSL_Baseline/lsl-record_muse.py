...
while os.path.isfile('/Users/mathlab/Desktop/Baseline/Data/Muse/%s_mac_muse_lsl_baseline.csv'%(partnum)) == True:
...
default_fname = ('/Users/mathlab/Desktop/Baseline/Data/Muse/%s.csv' % filename)
