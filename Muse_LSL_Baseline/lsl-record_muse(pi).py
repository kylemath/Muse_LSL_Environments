...
stop_eeg = [0]
np.savetxt('/home/pi/Experiments/Baseline/Stop_EEG.csv', (stop_eeg), delimiter=',',fmt="%s")

partnum = "001"

while os.path.isfile('/home/pi/Experiments/Baseline/Data/Muse/%s_muse_lsl_baseline.csv'%(partnum)) == True:
    partnum = '00'+str(int(partnum)+1)
    if int(partnum) > 9:
        partnum = '0' + str(int(partnum))

filename    = '%s_muse_lsl_baseline'%(partnum)

default_fname = ('/home/pi/Experiments/Baseline/Data/Muse/%s.csv' % filename)
...
while os.path.isfile('/home/pi/Experiments/Baseline/Stop_EEG.csv') == True:
#while inlet_marker:
    #check_stop = np.genfromtxt('/home/pi/Experiments/Baseline/Stop_EEG.csv', delimiter=',')
